...
import {
    ...
    Search, CheckCircle2, AlertCircle, Circle
} from 'lucide-react';
                        ...
                        <div className="relative h-full">
                            <div className="absolute top-6 left-6 z-10 flex items-center space-x-3 bg-slate-950/80 backdrop-blur-xl border border-white/10 p-2 rounded-2xl shadow-2xl">
                                ...
                                <span className="text-[11px] font-bold text-white uppercase tracking-widest px-2">
                                    {filteredDrivers.length} Drivers Active
                                </span>
                            </div>
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="flex items-start justify-between mb-3">
                                                ...
                                                <span
                                                    className={`inline-flex items-center px-2 py-1 rounded-lg text-[10px] font-bold uppercase tracking-widest border ${statusColors[driver.status as keyof typeof statusColors]
                                                        }`}
                                                >
